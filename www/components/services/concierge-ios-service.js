(function(){
    angular
        ...
        .factory('dbtConciergeIOS', function($rootScope, $timeout, $q, $http, dbtSounds, dbtApp, dbtStorageService, config) {
            var service = {};
            ...
            var uploadSuccess = function (r) {
              ...
              //  console.log('response.results.length: ', response.results.length);
                ...
                if(response.results.length > 0) {
                  ...
                  //dbtSounds.getSynthesis("Searching");
                  ...
                  //dbtSounds.getSynthesis(service.responseText);
                }
                //}, 200);
              //});
            };
            ...
            var uploadFail = function (error) {
              //$scope.$apply(function () {
                ...
                //dbtSounds.getSynthesis(service.initialPrompt);
              ...
              if(Media) {
                ...
                service.mediaRec = new Media(src,
                  ...
                  function (err) {
                    ...
                    dbtSounds.getSynthesis("I'm sorry. I wasn't able to fullfill your request. Could you please try again?");
                  }
                );
